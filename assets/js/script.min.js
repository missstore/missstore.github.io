	...
	if (from == "whatsapp") {
		...
		if (navigator.userAgent.match("Android") || navigator.userAgent.match("iPhone") || navigator.userAgent.match("iPad") || navigator.userAgentData.mobile) {
			...
			setTimeout(function() {
				/* window.document.hidden || window.document.webkitHidden ? window.open("https://instagram.com/miss.store.pvh") : null; */
				 document.querySelector('iframe.teste').contentDocument ? window.open("https://instagram.com/miss.store.pvh") : null;
			}, 1000);
		} else {
		...
		if (navigator.userAgent.match("Android") || navigator.userAgent.match("iPhone") || navigator.userAgent.match("iPad") || navigator.userAgentData.mobile) {
			...
			setTimeout(function() {
				...
				document.querySelector('iframe.teste').contentDocument ? window.open("https://www.facebook.com/106313655191627") : null;
			}, 1000);
		} else {
