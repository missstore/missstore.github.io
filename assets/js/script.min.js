...
wwm(".asimagensfull").then(function() {
	...
	document.querySelector(".asimagensfull").addEventListener("touchend", function(e) {
		LocalizacoesAtuais.forEach(function(e, i) {
			e >= 0 && e <= 210 || e <= 0 && e >= -150 ? document.querySelectorAll(".asimagensfull img")[i].scrollIntoView() : null;
		});
	});
});
