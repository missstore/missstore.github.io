...
function touchevents(elmnt) {
	...
	function touchdown(e) {
		...
		document.ontouchmove = moveimage;
	}
			...
			JSON.parse(req.response).info.forEach(function(e) {
				if (verificarsegrupoexiste(e.grupo)) {
					if (document.querySelector("div[grupo='" + e.grupo + "']")) {
						...
						navigator.userAgent.match("Android") || navigator.userAgent.match("iPhone") || navigator.userAgent.match("iPad") ? DivPrevNext.classList.add("mobile") : null;
