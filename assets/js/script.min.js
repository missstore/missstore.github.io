...
function fazersoma() {
	if (document.querySelectorAll(".adicionados .valordoproduto").length > 0) {
		...
		if(document.querySelector(".valortotal").textContent != ""){
			...
			let PrimeiraInstancia = ValorFormatado.split(",")[0];
			let SegundaInstancia = ValorFormatado.split(",")[1];
			let res1 = PrimeiraInstancia.length/2==2?PrimeiraInstancia.substring(0,PrimeiraInstancia.length/2-1):PrimeiraInstancia.substring(0,PrimeiraInstancia.length/2);
			let res2 = PrimeiraInstancia.length/2==2?PrimeiraInstancia.substring(PrimeiraInstancia.length/2-1,PrimeiraInstancia.length):PrimeiraInstancia.substring(PrimeiraInstancia.length/2,PrimeiraInstancia.length);
			let totalformatado = res2.length>=3?res1+"."+res2+","+SegundaInstancia:res1+res2+","+SegundaInstancia;
...
wwm(".fas.fa-home").then(function() {
	document.querySelector(".fas.fa-home").addEventListener("click", function() {
		window.location = "https://missstore.github.io/";
	});
});
