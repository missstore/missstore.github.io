		...
		if (multiplos) {
			...
			foto.forEach(function(e, i) {
				if (i == 0) {
					...
					document.querySelector(".fotofullviewing").insertBefore(novaimg, document.querySelector(".fotofullviewing").children[1]);
	...
	function criarImages(caminho) {
		...
		req.onload = function() {
			JSON.parse(req.response).info.forEach(function(e) {
				if (verificarsegrupoexiste(e.grupo)) {
					if (document.querySelector("div[grupo='" + e.grupo + "']")) {
						...
						document.querySelector("div[grupo='" + e.grupo + "']").style.background = inic +
							"," +
							'url("https://missstore.github.io/assets/img' + caminho + e.src + '") 150px center no-repeat';
						...
						novaImg.style.background = 'url("https://missstore.github.io/assets/img' + caminho + e.src + '") 0px center no-repeat';
				...
				let url = 'https://missstore.github.io/assets/img' + caminho + e.src,
					img = new Image();
				img.src = url;
