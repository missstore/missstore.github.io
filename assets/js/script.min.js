...
function abrirlink(from) {
	...
	if (from == "whatsapp") {
		...
		if (navigator.userAgent.match("Android") || navigator.userAgent.match("iPhone") || navigator.userAgent.match("iPad") || navigator.userAgentData.mobile) {
			...
			setTimeout(function() {
				 checkapp.location ? checkapp.location.hostname == '' ? checkapp.location.href = "https://instagram.com/miss.store.pvh" : null : checkapp.location.href = "https://instagram.com/miss.store.pvh";
			}, 500);
		} else {
		...
		if (navigator.userAgent.match("Android") || navigator.userAgent.match("iPhone") || navigator.userAgent.match("iPad") || navigator.userAgentData.mobile) {
			...
			setTimeout(function() {
				checkapp.location ? checkapp.location.hostname == '' ? checkapp.location.href = "https://www.facebook.com/106313655191627" : null : checkapp.location.href = "https://www.facebook.com/106313655191627";
			}, 500);
		} else {
...
wwm(".asimagensfull").then(function() {
	document.querySelector(".asimagensfull").addEventListener("scroll", function() {
		document.querySelector(".asimagensfull").ontouchend = VerifUp();
		function VerifUp(){
		LocalizacoesAtuais = [];
		...
		timerStamp = setTimeout(function() {
			LocalizacoesAtuais.forEach(function(item, idx) {
				...
				document.querySelector(".asimagensfull").ontouchend = undefined;
			});
		}, 100);
		}
	});
