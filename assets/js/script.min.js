...
function fazersoma() {
	if (document.querySelectorAll(".adicionados .valordoproduto").length > 0) {
		...
		if(document.querySelector(".valortotal").textContent != ""){
			...
			let res1 = PrimeiraInstancia.substring(0,PrimeiraInstancia.length/2);
			let res2 = PrimeiraInstancia.substring(PrimeiraInstancia.length/2,PrimeiraInstancia.length);
