...
function abrirlink(from) {
	if (from == "whatsapp") {
		window.open("https://wa.me/5569992841780");
			...
			setTimeout(function () {
				document.visibilityState == 'visible' ? window.open("https://instagram.com/miss.store.pvh") : null;
			}, 50);
			window.location = "instagram://user?username=miss.store.pvh";
	} else if (from == "facebook") {
			setTimeout(function () {
				document.visibilityState == 'visible' ? window.open("https://www.facebook.com/106313655191627") : null;
			}, 50);
			window.location = "fb://facewebmodal/f?href=https://www.facebook.com/106313655191627/";	
	}
}
...
function obterdadosdostorage() {
	for (let i = 0; i < localStorage.length; i++) {
		...
		i == localStorage.length - 1 ? wwm(".valortotal").then(function(){fazersoma();}) : null;
	}
}
