		...
		if (multiplos) {
			...
			foto.forEach(function(e, i) {
				if (i == 0) {
					...
					document.querySelector(".fotofullviewing .asimagensfull").insertBefore(novaimg, document.querySelector(".fotofullviewing .asimagensfull").children[1]);
	...
	function criarImages(caminho) {
		...
		req.onload = function() {
			JSON.parse(req.response).info.forEach(function(e) {
				...
				let url = '/assets/img' + caminho + e.src,
					img = new Image();
				img.src = url;
