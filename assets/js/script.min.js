let TodoConteudo = [],
	ProximaImagemIndex, PreviousImagemIndex, Modificada, selec;
...
function MoverImagens(elmnt) {
	var pos1 = 0,pos2 = 0,pos3 = 0,menosesse = 0,soma, eles = [],oindex,proximoindex;
			...
			JSON.parse(req.response).info.forEach(function(e) {
				if (verificarsegrupoexiste(e.grupo)) {
					if (document.querySelector("div[grupo='" + e.grupo + "']")) {
						...
						let n_u_a = navigator.userAgent.toLocaleLowerCase(), isMobile = navigator.userAgentData.mobile;
