...
function fazersoma() {
	if (document.querySelectorAll(".adicionados .valordoproduto").length > 0) {
		let soma = [];
		document.querySelector(".contagem .itens").textContent = 0;
		document.querySelectorAll(".adicionados .valordoproduto").forEach(function(i) {
			...
			document.querySelector(".contagem .itens").textContent = Number(document.querySelector(".contagem .itens").textContent) + Number(i.parentElement.parentElement.querySelector("input").value);
		});
