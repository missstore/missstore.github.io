...
function abrirlink(from) {
	if (from == "whatsapp") {
		...
		if (navigator.userAgent.match("Android") || navigator.userAgent.match("iPhone") || navigator.userAgent.match("iPad")) {
			...
			setTimeout(function() {
				alert(window.location);
				document.visibilityState == 'visible' && document.hasFocus() ? window.open("https://instagram.com/miss.store.pvh") : null;
			}, 250);
		} else {
		...
		if (navigator.userAgent.match("Android") || navigator.userAgent.match("iPhone") || navigator.userAgent.match("iPad")) {
			...
			setTimeout(function() {
				alert(window.location);
				document.visibilityState == 'visible' && document.hasFocus() ? window.open("https://www.facebook.com/106313655191627") : null;
			}, 250);
		} else {
